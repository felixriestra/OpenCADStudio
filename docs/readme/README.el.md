...
<p align="center"><img src="../../assets/logo.svg" width="112" alt="Λογότυπο του Mac2CAM"></p>
...
<p align="center">
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><img alt="Τελευταία έκδοση" src="https://img.shields.io/github/v/release/HakanSeven12/Mac2CAM"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases"><img alt="Λήψεις εκδόσεων" src="https://img.shields.io/github/downloads/HakanSeven12/Mac2CAM/total"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/stargazers"><img alt="Αστέρια στο GitHub" src="https://img.shields.io/github/stars/HakanSeven12/Mac2CAM"></a>
  <a href="../../LICENSE"><img alt="Άδεια GPL-3.0" src="https://img.shields.io/github/license/HakanSeven12/Mac2CAM"></a>
</p>

<p align="center">
  <a href="https://www.mac2cam.com"><strong>Άνοιγμα της διαδικτυακής εφαρμογής</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><strong>Λήψη της εφαρμογής για υπολογιστές</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/discussions"><strong>Συμμετοχή στη συζήτηση</strong></a>
</p>

<p align="center"><img src="../../site/workspace.png" alt="Χώρος εργασίας του Mac2CAM" width="100%"></p>

## Επισκόπηση

Το Mac2CAM είναι μια εφαρμογή για τεχνική σχεδίαση, διάταξη φύλλων και μοντελοποίηση στερεών, η οποία λειτουργεί σε διαφορετικές πλατφόρμες. Διαβάζει και γράφει απευθείας σχέδια DWG και DXF, με κοινό πυρήνα επεξεργασίας στις εκδόσεις για υπολογιστές και προγράμματα περιήγησης.

Το έργο βρίσκεται υπό ενεργή ανάπτυξη. Διατηρείτε αντίγραφα ασφαλείας των σημαντικών σχεδίων σας και αναφέρετε προβλήματα που μπορούν να αναπαραχθούν μέσω των [GitHub Issues](https://github.com/HakanSeven12/Mac2CAM/issues).
...
<p align="center"><img src="../../site/modeling.png" alt="Τρισδιάστατο μοντέλο στο Mac2CAM" width="100%"></p>
...
Χρησιμοποιήστε τη [διαδικτυακή εφαρμογή](https://www.mac2cam.com) για άμεση πρόσβαση χωρίς εγκατάσταση. Τα σχέδια επιλέγονται μέσω του προγράμματος περιήγησης και αποθηκεύονται ως τοπικές λήψεις.
...
Κατεβάστε όλα τα τρέχοντα πακέτα από την [τελευταία έκδοση](https://github.com/HakanSeven12/Mac2CAM/releases/latest).

### Windows

Επιλέξτε ένα από τα υπογεγραμμένα πακέτα x86-64:

- `Mac2CAM-*-windows-x86_64-installer.msi` — το προτεινόμενο πρόγραμμα εγκατάστασης, με συντομεύσεις στο μενού Έναρξη, συσχετίσεις αρχείων DWG/DXF και μικρογραφίες σχεδίων.
- `Mac2CAM-*-windows-x86_64-portable.exe` — αυτόνομη εφαρμογή που δεν απαιτεί εγκατάσταση.
...
1. Κατεβάστε το `Mac2CAM-*-macos-arm64.dmg`.
2. Ανοίξτε την εικόνα δίσκου και σύρετε το `Mac2CAM.app` στον φάκελο **Εφαρμογές (Applications)**.
...
Το Mac2CAM μπορεί να ακολουθεί τη γλώσσα του συστήματος ή να χρησιμοποιεί μία από τις ακόλουθες 21 γλώσσες περιβάλλοντος:
...
Το εκτελέσιμο αρχείο δημιουργείται στη θέση `target/release/Mac2CAM` (`Mac2CAM.exe` στα Windows).
...
Ο διακομιστής αυτοματισμού ανταλλάσσει ένα αντικείμενο JSON ανά γραμμή μέσω της τυπικής εισόδου/εξόδου ή μιας τοπικής υποδοχής TCP. Το αυτοτελές σημείο σύνδεσης MCP παρέχει πρόσβαση στον ενεργό επεξεργαστή της εφαρμογής μέσω των ίδιων εργαλείων σε κάθε συμβατό πελάτη. Για τη σύνδεση, ρυθμίστε τον πελάτη ώστε να εκκινεί το `Mac2CAM --mcp`. Δείτε τον [οδηγό ελέγχου MCP](../automation/README.md).
...
- Αναζητήστε στα υπάρχοντα [issues](https://github.com/HakanSeven12/Mac2CAM/issues) πριν υποβάλετε νέα αναφορά.
- Χρησιμοποιήστε τα [Discussions](https://github.com/HakanSeven12/Mac2CAM/discussions) για ερωτήσεις και ιδέες.
...
<a href="https://github.com/HakanSeven12/Mac2CAM/stargazers">
  <picture>
    ...
    <img alt="Ιστορικό αστεριών του Mac2CAM" src="https://www.mac2cam.com/star-history-light.svg">
  </picture>
</a>
...
<a href="https://github.com/HakanSeven12/Mac2CAM/releases">
  <picture>
    ...
    <img alt="Ιστορικό λήψεων εκδόσεων του Mac2CAM" src="https://www.mac2cam.com/download-history-light.svg">
  </picture>
</a>

## Υποστήριξη του έργου

Αν το Mac2CAM σας βοηθά στην εργασία σας, υποστηρίξτε τη συνεχή ανάπτυξή του μέσω του [GitHub Sponsors](https://github.com/sponsors/HakanSeven12) ή του [Patreon](https://www.patreon.com/HakanSeven12).

## Άδεια χρήσης

Το Mac2CAM διανέμεται υπό τη [Γενική Άδεια Δημόσιας Χρήσης GNU v3.0](../../LICENSE).
