...
<p align="center"><img src="../../assets/logo.svg" width="112" alt="Логотип Mac2CAM"></p>
...
<p align="center">
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><img alt="Последняя версия" src="https://img.shields.io/github/v/release/HakanSeven12/Mac2CAM"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases"><img alt="Загрузки" src="https://img.shields.io/github/downloads/HakanSeven12/Mac2CAM/total"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/stargazers"><img alt="Звёзды GitHub" src="https://img.shields.io/github/stars/HakanSeven12/Mac2CAM"></a>
  <a href="../../LICENSE"><img alt="Лицензия GPL-3.0" src="https://img.shields.io/github/license/HakanSeven12/Mac2CAM"></a>
</p>

<p align="center">
  <a href="https://www.mac2cam.com"><strong>Запустить веб-приложение</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><strong>Скачать приложение для компьютера</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/discussions"><strong>Присоединиться к обсуждению</strong></a>
</p>

<p align="center"><img src="../../site/workspace.png" alt="Рабочее пространство Mac2CAM" width="100%"></p>

## Обзор

Mac2CAM — кроссплатформенное приложение для технического черчения, работы с листами и моделирования тел. Оно напрямую читает и записывает чертежи DWG и DXF; версии для компьютера и браузера используют общее ядро редактирования.

Проект активно развивается. Храните резервные копии важных рабочих чертежей и сообщайте о воспроизводимых проблемах через [GitHub Issues](https://github.com/HakanSeven12/Mac2CAM/issues).
...
<p align="center"><img src="../../site/modeling.png" alt="3D-модель в Mac2CAM" width="100%"></p>
...
Используйте [веб-приложение](https://www.mac2cam.com), чтобы начать без установки. Чертежи выбираются в браузере и сохраняются как локальные загрузки.
...
Все актуальные пакеты доступны в [последнем выпуске](https://github.com/HakanSeven12/Mac2CAM/releases/latest).

### Windows

Выберите один из подписанных пакетов x86-64:

- `Mac2CAM-*-windows-x86_64-installer.msi` — рекомендуемый установщик с ярлыками в меню «Пуск», ассоциациями DWG/DXF и миниатюрами чертежей.
- `Mac2CAM-*-windows-x86_64-portable.exe` — автономное приложение, не требующее установки.
...
1. Скачайте `Mac2CAM-*-macos-arm64.dmg`.
2. Откройте образ и перетащите `Mac2CAM.app` в **Applications**.
...
Mac2CAM может следовать языку системы или использовать любой из следующих языков интерфейса (всего 21):
...
Готовый файл находится в `target/release/Mac2CAM` (`Mac2CAM.exe` в Windows).
...
- Перед созданием нового сообщения выполните поиск по существующим [issues](https://github.com/HakanSeven12/Mac2CAM/issues).
- Для вопросов и идей используйте [Discussions](https://github.com/HakanSeven12/Mac2CAM/discussions).
...
<a href="https://github.com/HakanSeven12/Mac2CAM/stargazers">
  <picture>
    ...
    <img alt="Звёзды и загрузки выпусков Mac2CAM" src="https://www.mac2cam.com/star-history-light.svg">
  </picture>
</a>

## Поддержать проект

Если Mac2CAM помогает в вашей работе, поддержите дальнейшую разработку через [GitHub Sponsors](https://github.com/sponsors/HakanSeven12) или [Patreon](https://www.patreon.com/HakanSeven12).

## Лицензия

Mac2CAM распространяется по [GNU General Public License v3.0](../../LICENSE).
