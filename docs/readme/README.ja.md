...
<p align="center"><img src="../../assets/logo.svg" width="112" alt="Mac2CAM ロゴ"></p>
<h1 align="center">Mac2CAM</h1>
<p align="center">Rust で開発された、デスクトップと Web 向けのオープンソース 2D 製図・3D モデリングアプリケーション。</p>

<p align="center">
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><img alt="最新リリース" src="https://img.shields.io/github/v/release/HakanSeven12/Mac2CAM"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases"><img alt="ダウンロード数" src="https://img.shields.io/github/downloads/HakanSeven12/Mac2CAM/total"></a>
  <a href="https://github.com/HakanSeven12/Mac2CAM/stargazers"><img alt="GitHub スター" src="https://img.shields.io/github/stars/HakanSeven12/Mac2CAM"></a>
  <a href="../../LICENSE"><img alt="GPL-3.0 ライセンス" src="https://img.shields.io/github/license/HakanSeven12/Mac2CAM"></a>
</p>

<p align="center">
  <a href="https://www.mac2cam.com"><strong>Web アプリを起動</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/releases/latest"><strong>デスクトップアプリをダウンロード</strong></a> ·
  <a href="https://github.com/HakanSeven12/Mac2CAM/discussions"><strong>ディスカッションに参加</strong></a>
</p>

<p align="center"><img src="../../site/workspace.png" alt="Mac2CAM ワークスペース" width="100%"></p>

## 概要

Mac2CAM は、技術製図、レイアウト作業、ソリッドモデリングのためのクロスプラットフォームアプリケーションです。DWG および DXF 図面をネイティブに読み書きし、デスクトップ版とブラウザ版で共通の編集コアを使用します。

本プロジェクトは活発に開発されています。重要な実務図面はバックアップを保存し、再現可能な問題は [GitHub Issues](https://github.com/HakanSeven12/Mac2CAM/issues) で報告してください。
...
<p align="center"><img src="../../site/modeling.png" alt="Mac2CAM の 3D モデル" width="100%"></p>
...
インストールせずにすぐ使うには [Web アプリ](https://www.mac2cam.com) を利用してください。図面はブラウザで選択し、ローカルダウンロードとして保存されます。
...
現在のすべてのパッケージは [最新リリース](https://github.com/HakanSeven12/Mac2CAM/releases/latest) からダウンロードできます。

### Windows

署名済み x86-64 パッケージのいずれかを選択します。

- `Mac2CAM-*-windows-x86_64-installer.msi` — スタートメニューのショートカット、DWG/DXF 関連付け、図面サムネイルを含む推奨インストーラー。
- `Mac2CAM-*-windows-x86_64-portable.exe` — インストール不要のスタンドアロンアプリケーション。
...
1. `Mac2CAM-*-macos-arm64.dmg` をダウンロードします。
2. イメージを開き、`Mac2CAM.app` を **Applications** にドラッグします。
...
Mac2CAM はシステム言語に従うか、次の 21 のインターフェース言語を使用できます。
...
生成されたバイナリは `target/release/Mac2CAM` に保存されます（Windows では `Mac2CAM.exe`）。
...
- 新しい報告を作成する前に既存の [issues](https://github.com/HakanSeven12/Mac2CAM/issues) を検索してください。
- 質問やアイデアには [Discussions](https://github.com/HakanSeven12/Mac2CAM/discussions) を利用してください。
...
<a href="https://github.com/HakanSeven12/Mac2CAM/stargazers">
  <picture>
    ...
    <img alt="Mac2CAM のスター数とリリースダウンロード数" src="https://www.mac2cam.com/star-history-light.svg">
  </picture>
</a>

## プロジェクトを支援

Mac2CAM が作業に役立つ場合は、[GitHub Sponsors](https://github.com/sponsors/HakanSeven12) または [Patreon](https://www.patreon.com/HakanSeven12) で継続的な開発をご支援ください。

## ライセンス

Mac2CAM は [GNU General Public License v3.0](../../LICENSE) の下で配布されています。
