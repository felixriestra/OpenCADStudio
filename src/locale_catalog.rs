...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "= {v}" => Some(("inquiry", "v")),
        "A newer Mac2CAM version is published on GitHub." => Some(("ui", "a-newer-mac2cam-version-is-published-o")),
        ...
        "Make Mac2CAM your default CAD app?" => Some(("modal", "make-mac2cam-your-default-cad-app")),
        ...
        "Open .dwg and .dxf drawings in Mac2CAM by default. You can change this later in your system settings." => Some(("modal", "open-dwg-and-dxf-drawings-in-mac2cam-b")),
        "Mac2CAM could not trust the certificate presented for the plugin registry. Check your system certificate and proxy settings, then retry." => Some(("plugins", "mac2cam-could-not-trust-the-certificat")),
        "Mac2CAM plugins are native packages and cannot run inside a browser. Download the desktop app to browse, install, and use plugins." => Some(("plugins", "mac2cam-plugins-are-native-packages-an")),
        "Mac2CAM ready." => Some(("file", "mac2cam-ready")),
        ...
        "Save stopped: \"{file_name}\" changed outside Mac2CAM." => Some(("file", "save-stopped-file-name-changed-outside-open-ca")),
        ...
        "Mac2CAM — 2D/3D CAD editor" => Some(("common", "mac2cam-2d-3d-cad-editor")),
        ...
        "Mac2CAM renderer error — copy this into a bug report:" => Some(("common", "mac2cam-renderer-error-copy-this-into-a-bug-report")),
        ...
        "Open .dwg and .dxf files with Mac2CAM" => Some(("common", "open-dwg-and-dxf-files-with-mac2cam")),
        ...
        "Mac2CAM Web App" => Some(("common", "mac2cam-web-app")),
        ...
        "Launch Mac2CAM" => Some(("common", "launch-mac2cam")),
        "Mac2CAM Installer" => Some(("common", "mac2cam-installer")),
        "DWG Drawing" => Some(("common", "dwg-drawing")),
        "DXF Drawing" => Some(("common", "dxf-drawing")),
        "Desktop shortcut" => Some(("common", "desktop-shortcut")),
        "Add a shortcut to Mac2CAM on the desktop." => Some(("common", "add-a-shortcut-to-mac2cam-on-the-desktop")),
